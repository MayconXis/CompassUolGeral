...
Resource    ../data/banco_endpoints.json
Documentation    Testes de Manipulacao do Banco de Dados JSON
Library          Collections

*** Variables ***
${BANCO_ENDPOINTS}    ../data/banco_endpoints.json

*** Test Cases ***
Cenario Manipulacao Banco 01: Adicionar Novo Usuario ao Banco JSON
...
Cenario Manipulacao Banco 02: Contar Usuarios no Banco
    [Tags]    JSON    CONSULTA
...
Cenario Manipulacao Banco 03: Validar Estrutura dos Bancos JSON
    [Tags]    JSON    VALIDACAO
...
Cenario Manipulacao Banco 04: Testar Busca de Usuario Inexistente
    [Tags]    JSON    ERRO
...
Cenario Manipulacao Banco 05: Adicionar e Remover Usuario Dinamicamente
    [Tags]    JSON    CRUD
...
Cenario Manipulacao Banco 06: Testar Todos os Usuarios do Banco Dinamicamente
    [Tags]    JSON    DINAMICO
